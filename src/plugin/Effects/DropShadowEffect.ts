...
export class DropShadowEffectContainer {
    type: 'DROP_SHADOW' = 'DROP_SHADOW';
    color: {
        r: number
        g: number
        b: number
    ...
    constructor(effect: DropShadowEffect) {
        this.color = {
            r: effect.color.r,
            g: effect.color.g,
            b: effect.color.b,
        ...
        this.showShadowBehindNode = effect.showShadowBehindNode;
    }
}